...
public class HashidsTest {
    ...
    public void test_randomness_for_incrementing() {
        ...
        assertEquals(a.encode(1L), "NV");
        assertEquals(a.encode(2L), "6m");
        assertEquals(a.encode(3L), "yD");
        assertEquals(a.encode(4L), "2l");
        assertEquals(a.encode(5L), "rD");
    }

    @Test
    public void test_for_vlues_greater_int_maxval() {
        final Hashids a = new Hashids("this is my salt");
        assertEquals(a.encode(9876543210123L), "Y8r7W1kNN");
    }
